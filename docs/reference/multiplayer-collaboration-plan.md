...
> **文档索引**: `docs/document-index.md` 已于 2026-05-22 同步到 #18、Polish Story 001-003 完成状态。Epic #1-#18 Complete + Sprint 003 domain-backed playable evidence 已通过 Production → Polish gate；fresh perf probe 已修复并通过，Navigation/Exploration runtime hardening、authored route/search content slice、真实 preflight、dynamic Exploration semantics、windowed screenshot evidence 已完成，后续进入 content scale-up / art-audio treatment 的普通 Polish backlog。
