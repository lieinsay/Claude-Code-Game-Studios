...
| [production/sprints/sprint-003-domain-backed-playable-slice.md](../production/sprints/sprint-003-domain-backed-playable-slice.md) | 当前 Production Sprint 003 — PVS3-001..PVS3-006 已完成 C# runtime authority、canonical Persistence、最低灰盒表现和自动 smoke 证据；继续 PVS3-007 人工 QA |
