#!/usr/bin/env python3
"""Generate Codex adapters for CCGS skills from canonical .claude skills."""
...
def render_index(skills: list[tuple[str, str, Path]]) -> str:
    lines = [
        ...
        "",
        "These adapter files are generated by `python tools/sync_codex_adapters.py`.",
        "The canonical source remains `.claude/skills/*/SKILL.md`.",
        "",
        f"Total: {len(skills)}",
        "",
    ]
...
def expected_files() -> dict[Path, str]:
    ...
    for name, description, source in skills:
        files[AGENTS_SKILLS / name / "SKILL.md"] = render_skill(
...
def check_files(files: dict[Path, str]) -> int:
    ...
    if mismatches:
        ...
        for item in mismatches:
            print(f"- {item}")
        print("Run: python tools/sync_codex_adapters.py")
        return 1
...
def main() -> int:
    ...
    parser.add_argument("--check", action="store_true", help="Verify adapters.")
