---
name: design-review
description: "Codex adapter for the original CCGS `design-review` workflow. Canonical source: `.claude/skills/design-review/SKILL.md`. Reviews a game design document for completeness, internal consistency, implementability, and adherence to project design standards. Run this before handing a design document to programmers."
---

# Codex Adapter: `design-review`

Canonical source: `../../../.claude/skills/design-review/SKILL.md`
...
- Update `.claude/skills/design-review/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
