...
description: "Codex adapter for the original CCGS `project-stage-detect` workflow. Canonical source: `.claude/skills/project-stage-detect/SKILL.md`. Automatically analyze project state, detect stage, identify gaps, and recommend next steps based on existing artifacts. Use when user asks 'where are we in development', 'what stage are we in', 'full project audit'."
---

# Codex Adapter: `project-stage-detect`

Canonical source: `../../../.claude/skills/project-stage-detect/SKILL.md`
...
- Update `.claude/skills/project-stage-detect/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
