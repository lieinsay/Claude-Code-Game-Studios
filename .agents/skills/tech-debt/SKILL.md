---
name: tech-debt
description: "Codex adapter for the original CCGS `tech-debt` workflow. Canonical source: `.claude/skills/tech-debt/SKILL.md`. Track, categorize, and prioritize technical debt across the codebase. Scans for debt indicators, maintains a debt register, and recommends repayment scheduling."
---

# Codex Adapter: `tech-debt`

Canonical source: `../../../.claude/skills/tech-debt/SKILL.md`
...
- Update `.claude/skills/tech-debt/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
