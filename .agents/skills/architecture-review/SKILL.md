...
description: "Codex adapter for the original CCGS `architecture-review` workflow. Canonical source: `.claude/skills/architecture-review/SKILL.md`. Validates completeness and consistency of the project architecture against all GDDs. Builds a traceability matrix mapping every GDD technical requirement to ADRs, identifies coverage gaps, detects cross-ADR conflicts, verifies engine compatibility consistency across all decisions, and produces a PASS/CONCERNS/FAIL verdict. The architecture equivalent of /design-review."
---

# Codex Adapter: `architecture-review`

Canonical source: `../../../.claude/skills/architecture-review/SKILL.md`
...
- Update `.claude/skills/architecture-review/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
