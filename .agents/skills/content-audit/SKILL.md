---
name: content-audit
description: "Codex adapter for the original CCGS `content-audit` workflow. Canonical source: `.claude/skills/content-audit/SKILL.md`. Audit GDD-specified content counts against implemented content. Identifies what's planned vs built."
---

# Codex Adapter: `content-audit`

Canonical source: `../../../.claude/skills/content-audit/SKILL.md`
...
- Update `.claude/skills/content-audit/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
