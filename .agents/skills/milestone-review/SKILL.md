...
description: "Codex adapter for the original CCGS `milestone-review` workflow. Canonical source: `.claude/skills/milestone-review/SKILL.md`. Generates a comprehensive milestone progress review including feature completeness, quality metrics, risk assessment, and go/no-go recommendation. Use at milestone checkpoints or when evaluating readiness for a milestone deadline."
---

# Codex Adapter: `milestone-review`

Canonical source: `../../../.claude/skills/milestone-review/SKILL.md`
...
- Update `.claude/skills/milestone-review/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
