---
name: hotfix
description: "Codex adapter for the original CCGS `hotfix` workflow. Canonical source: `.claude/skills/hotfix/SKILL.md`. Emergency fix workflow that bypasses normal sprint processes with a full audit trail. Creates hotfix branch, tracks approvals, and ensures the fix is backported correctly."
---

# Codex Adapter: `hotfix`

Canonical source: `../../../.claude/skills/hotfix/SKILL.md`
...
- Update `.claude/skills/hotfix/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
