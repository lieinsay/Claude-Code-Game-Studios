---
name: skill-test
description: "Codex adapter for the original CCGS `skill-test` workflow. Canonical source: `.claude/skills/skill-test/SKILL.md`. Validate skill files for structural compliance and behavioral correctness. Three modes: static (linter), spec (behavioral), audit (coverage report)."
---

# Codex Adapter: `skill-test`

Canonical source: `../../../.claude/skills/skill-test/SKILL.md`
...
- Update `.claude/skills/skill-test/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
