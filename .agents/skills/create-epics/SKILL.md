---
name: create-epics
description: "Codex adapter for the original CCGS `create-epics` workflow. Canonical source: `.claude/skills/create-epics/SKILL.md`. Translate approved GDDs + architecture into epics — one epic per architectural module. Defines scope, governing ADRs, engine risk, and untraced requirements. Does NOT break into stories — run /create-stories [epic-slug] after each epic is created."
---

# Codex Adapter: `create-epics`

Canonical source: `../../../.claude/skills/create-epics/SKILL.md`
...
- Update `.claude/skills/create-epics/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
