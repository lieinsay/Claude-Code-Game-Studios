---
name: team-combat
description: "Codex adapter for the original CCGS `team-combat` workflow. Canonical source: `.claude/skills/team-combat/SKILL.md`. Orchestrate the combat team: coordinates game-designer, gameplay-programmer, ai-programmer, technical-artist, sound-designer, and qa-tester to design, implement, and validate a combat feature end-to-end."
---

# Codex Adapter: `team-combat`

Canonical source: `../../../.claude/skills/team-combat/SKILL.md`
...
- Update `.claude/skills/team-combat/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
