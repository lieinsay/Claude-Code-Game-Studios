---
name: test-setup
description: "Codex adapter for the original CCGS `test-setup` workflow. Canonical source: `.claude/skills/test-setup/SKILL.md`. Scaffold the test framework and CI/CD pipeline for the project's engine. Creates the tests/ directory structure, engine-specific test runner configuration, and GitHub Actions workflow. Run once during Technical Setup phase before the first sprint begins."
---

# Codex Adapter: `test-setup`

Canonical source: `../../../.claude/skills/test-setup/SKILL.md`
...
- Update `.claude/skills/test-setup/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
