---
name: perf-profile
description: "Codex adapter for the original CCGS `perf-profile` workflow. Canonical source: `.claude/skills/perf-profile/SKILL.md`. Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings."
---

# Codex Adapter: `perf-profile`

Canonical source: `../../../.claude/skills/perf-profile/SKILL.md`
...
- Update `.claude/skills/perf-profile/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
