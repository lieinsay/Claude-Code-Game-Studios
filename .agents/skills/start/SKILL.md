---
name: start
description: "Codex adapter for the original CCGS `start` workflow. Canonical source: `.claude/skills/start/SKILL.md`. First-time onboarding — asks where you are, then guides you to the right workflow. No assumptions."
---

# Codex Adapter: `start`

Canonical source: `../../../.claude/skills/start/SKILL.md`
...
- Update `.claude/skills/start/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
