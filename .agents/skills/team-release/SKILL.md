---
name: team-release
description: "Codex adapter for the original CCGS `team-release` workflow. Canonical source: `.claude/skills/team-release/SKILL.md`. Orchestrate the release team: coordinates release-manager, qa-lead, devops-engineer, and producer to execute a release from candidate to deployment."
---

# Codex Adapter: `team-release`

Canonical source: `../../../.claude/skills/team-release/SKILL.md`
...
- Update `.claude/skills/team-release/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
