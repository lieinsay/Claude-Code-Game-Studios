---
name: team-level
description: "Codex adapter for the original CCGS `team-level` workflow. Canonical source: `.claude/skills/team-level/SKILL.md`. Orchestrate level design team: level-designer + narrative-director + world-builder + art-director + systems-designer + qa-tester for complete area/level creation."
---

# Codex Adapter: `team-level`

Canonical source: `../../../.claude/skills/team-level/SKILL.md`
...
- Update `.claude/skills/team-level/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
