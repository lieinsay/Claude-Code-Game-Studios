...
description: "Codex adapter for the original CCGS `godot-asset-execute` workflow. Canonical source: `.claude/skills/godot-asset-execute/SKILL.md`. Project-local adapter for the vendored Godot asset execution workflow. Use to execute approved or explicitly risk-accepted Godot Asset Contracts through Godot AI MCP and record verification evidence."
---

# Codex Adapter: `godot-asset-execute`

Canonical source: `../../../.claude/skills/godot-asset-execute/SKILL.md`
...
Project-local adapter for the vendored Godot asset execution workflow. Use to execute approved or explicitly risk-accepted Godot Asset Contracts through Godot AI MCP and record verification evidence.

## Maintenance

- Do not edit this generated file directly.
- Update `.claude/skills/godot-asset-execute/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
