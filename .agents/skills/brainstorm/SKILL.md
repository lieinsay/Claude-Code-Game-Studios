---
name: brainstorm
description: "Codex adapter for the original CCGS `brainstorm` workflow. Canonical source: `.claude/skills/brainstorm/SKILL.md`. Guided game concept ideation — from zero idea to a structured game concept document. Uses professional studio ideation techniques, player psychology frameworks, and structured creative exploration."
---

# Codex Adapter: `brainstorm`

Canonical source: `../../../.claude/skills/brainstorm/SKILL.md`
...
- Update `.claude/skills/brainstorm/SKILL.md` or `tools/sync_codex_adapters.py`, then run:
