...
---
> Codex compatibility: migrated from `.claude/skills/propagate-design-change/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash, Task", "agent": "technical-director"}`.
>
> Invocation in this template uses `$propagate-design-change`. If structured user input
