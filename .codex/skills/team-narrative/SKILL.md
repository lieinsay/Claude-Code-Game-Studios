...
---
> Codex compatibility: migrated from `.claude/skills/team-narrative/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Task, AskUserQuestion, TodoWrite"}`.
>
> Invocation in this template uses `$team-narrative`. If structured user input
