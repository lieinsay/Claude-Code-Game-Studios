...
---
> Codex compatibility: migrated from `.claude/skills/hotfix/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task"}`.
>
> Invocation in this template uses `$hotfix`. If structured user input
