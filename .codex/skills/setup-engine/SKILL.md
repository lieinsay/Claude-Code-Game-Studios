...
---
> Codex compatibility: migrated from `.claude/skills/setup-engine/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, WebSearch, WebFetch, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$setup-engine`. If structured user input
