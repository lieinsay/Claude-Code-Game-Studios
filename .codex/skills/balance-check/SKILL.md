...
---
> Codex compatibility: migrated from `.claude/skills/balance-check/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep", "agent": "economy-designer"}`.
>
> Invocation in this template uses `$balance-check`. If structured user input
