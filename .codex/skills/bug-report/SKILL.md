...
---
> Codex compatibility: migrated from `.claude/skills/bug-report/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$bug-report`. If structured user input
