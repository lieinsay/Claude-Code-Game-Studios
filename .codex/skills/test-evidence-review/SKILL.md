...
---
> Codex compatibility: migrated from `.claude/skills/test-evidence-review/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write"}`.
>
> Invocation in this template uses `$test-evidence-review`. If structured user input
