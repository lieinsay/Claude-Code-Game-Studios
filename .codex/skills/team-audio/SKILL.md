...
---
> Codex compatibility: migrated from `.claude/skills/team-audio/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-audio`. If structured user input
