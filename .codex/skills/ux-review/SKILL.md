...
---
> Codex compatibility: migrated from `.claude/skills/ux-review/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep", "agent": "ux-designer"}`.
>
> Invocation in this template uses `$ux-review`. If structured user input
