...
---
> Codex compatibility: migrated from `.claude/skills/perf-profile/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "agent": "performance-analyst", "allowed-tools": "Read, Glob, Grep, Bash"}`.
>
> Invocation in this template uses `$perf-profile`. If structured user input
