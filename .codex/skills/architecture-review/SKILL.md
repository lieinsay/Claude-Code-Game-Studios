...
---
> Codex compatibility: migrated from `.claude/skills/architecture-review/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task, AskUserQuestion", "agent": "technical-director", "model": "opus"}`.
>
> Invocation in this template uses `$architecture-review`. If structured user input
