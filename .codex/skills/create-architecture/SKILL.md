...
---
> Codex compatibility: migrated from `.claude/skills/create-architecture/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash, AskUserQuestion, Task", "agent": "technical-director"}`.
>
> Invocation in this template uses `$create-architecture`. If structured user input
