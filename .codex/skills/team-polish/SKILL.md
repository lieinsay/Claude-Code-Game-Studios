...
---
> Codex compatibility: migrated from `.claude/skills/team-polish/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-polish`. If structured user input
