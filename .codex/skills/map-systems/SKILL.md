...
---
> Codex compatibility: migrated from `.claude/skills/map-systems/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, AskUserQuestion, TodoWrite, Task"}`.
>
> Invocation in this template uses `$map-systems`. If structured user input
