...
---
> Codex compatibility: migrated from `.claude/skills/design-review/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$design-review`. If structured user input
