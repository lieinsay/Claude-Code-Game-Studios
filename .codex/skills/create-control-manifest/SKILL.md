...
---
> Codex compatibility: migrated from `.claude/skills/create-control-manifest/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task", "agent": "technical-director"}`.
>
> Invocation in this template uses `$create-control-manifest`. If structured user input
