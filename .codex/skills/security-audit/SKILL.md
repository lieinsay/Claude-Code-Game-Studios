...
---
> Codex compatibility: migrated from `.claude/skills/security-audit/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Write, Task", "agent": "security-engineer"}`.
>
> Invocation in this template uses `$security-audit`. If structured user input
