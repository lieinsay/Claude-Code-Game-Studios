...
---
> Codex compatibility: migrated from `.claude/skills/art-bible/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$art-bible`. If structured user input
