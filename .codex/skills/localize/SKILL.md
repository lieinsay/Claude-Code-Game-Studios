...
---
> Codex compatibility: migrated from `.claude/skills/localize/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "agent": "localization-lead", "allowed-tools": "Read, Glob, Grep, Write, Bash, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$localize`. If structured user input
