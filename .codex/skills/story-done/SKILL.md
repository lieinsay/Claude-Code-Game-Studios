...
---
> Codex compatibility: migrated from `.claude/skills/story-done/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Write, Edit, AskUserQuestion, Task"}`.
>
> Invocation in this template uses `$story-done`. If structured user input
