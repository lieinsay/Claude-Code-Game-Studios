...
---
> Codex compatibility: migrated from `.claude/skills/asset-audit/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep"}`.
>
> Invocation in this template uses `$asset-audit`. If structured user input
