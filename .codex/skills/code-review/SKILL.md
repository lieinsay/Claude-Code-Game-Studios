...
---
> Codex compatibility: migrated from `.claude/skills/code-review/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Task", "agent": "lead-programmer"}`.
>
> Invocation in this template uses `$code-review`. If structured user input
