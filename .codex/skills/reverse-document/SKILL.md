...
---
> Codex compatibility: migrated from `.claude/skills/reverse-document/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$reverse-document`. If structured user input
