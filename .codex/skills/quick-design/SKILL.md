...
---
> Codex compatibility: migrated from `.claude/skills/quick-design/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$quick-design`. If structured user input
