...
---
> Codex compatibility: migrated from `.claude/skills/prototype/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task", "agent": "prototyper", "isolation": "worktree"}`.
>
> Invocation in this template uses `$prototype`. If structured user input
