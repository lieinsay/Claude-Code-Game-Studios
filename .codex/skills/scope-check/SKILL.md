...
---
> Codex compatibility: migrated from `.claude/skills/scope-check/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash", "model": "haiku"}`.
>
> Invocation in this template uses `$scope-check`. If structured user input
