...
---
> Codex compatibility: migrated from `.claude/skills/help/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$help`. If structured user input
