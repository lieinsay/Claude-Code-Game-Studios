...
---
> Codex compatibility: migrated from `.claude/skills/onboard/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write", "model": "haiku"}`.
>
> Invocation in this template uses `$onboard`. If structured user input
