...
---
> Codex compatibility: migrated from `.claude/skills/asset-spec/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$asset-spec`. If structured user input
