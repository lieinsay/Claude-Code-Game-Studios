...
---
> Codex compatibility: migrated from `.claude/skills/skill-improve/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash"}`.
>
> Invocation in this template uses `$skill-improve`. If structured user input
