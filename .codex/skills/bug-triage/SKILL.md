...
---
> Codex compatibility: migrated from `.claude/skills/bug-triage/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$bug-triage`. If structured user input
