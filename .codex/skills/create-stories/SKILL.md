...
---
> Codex compatibility: migrated from `.claude/skills/create-stories/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task, AskUserQuestion", "agent": "lead-programmer"}`.
>
> Invocation in this template uses `$create-stories`. If structured user input
