...
---
> Codex compatibility: migrated from `.claude/skills/team-level/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-level`. If structured user input
