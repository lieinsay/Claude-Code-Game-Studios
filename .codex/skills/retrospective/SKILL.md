...
---
> Codex compatibility: migrated from `.claude/skills/retrospective/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write", "context": "|"}`.
>
> Invocation in this template uses `$retrospective`. If structured user input
