...
---
> Codex compatibility: migrated from `.claude/skills/test-flakiness/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$test-flakiness`. If structured user input
