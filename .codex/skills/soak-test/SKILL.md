...
---
> Codex compatibility: migrated from `.claude/skills/soak-test/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$soak-test`. If structured user input
