...
---
> Codex compatibility: migrated from `.claude/skills/release-checklist/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$release-checklist`. If structured user input
