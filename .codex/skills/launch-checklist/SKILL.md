...
---
> Codex compatibility: migrated from `.claude/skills/launch-checklist/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$launch-checklist`. If structured user input
