...
---
> Codex compatibility: migrated from `.claude/skills/consistency-check/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$consistency-check`. If structured user input
