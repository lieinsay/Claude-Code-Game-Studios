...
---
> Codex compatibility: migrated from `.claude/skills/create-epics/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task, AskUserQuestion", "agent": "technical-director"}`.
>
> Invocation in this template uses `$create-epics`. If structured user input
