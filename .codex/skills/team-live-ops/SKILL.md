...
---
> Codex compatibility: migrated from `.claude/skills/team-live-ops/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task, AskUserQuestion, TodoWrite"}`.
>
> Invocation in this template uses `$team-live-ops`. If structured user input
