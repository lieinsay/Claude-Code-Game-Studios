...
---
> Codex compatibility: migrated from `.claude/skills/adopt/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, AskUserQuestion", "agent": "technical-director"}`.
>
> Invocation in this template uses `$adopt`. If structured user input
