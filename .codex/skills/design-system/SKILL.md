...
---
> Codex compatibility: migrated from `.claude/skills/design-system/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$design-system`. If structured user input
