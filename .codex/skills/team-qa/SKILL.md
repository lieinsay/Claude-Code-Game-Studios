...
---
> Codex compatibility: migrated from `.claude/skills/team-qa/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task, AskUserQuestion", "agent": "qa-lead"}`.
>
> Invocation in this template uses `$team-qa`. If structured user input
