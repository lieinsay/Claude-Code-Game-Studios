...
---
> Codex compatibility: migrated from `.claude/skills/story-readiness/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, AskUserQuestion, Task", "model": "haiku"}`.
>
> Invocation in this template uses `$story-readiness`. If structured user input
