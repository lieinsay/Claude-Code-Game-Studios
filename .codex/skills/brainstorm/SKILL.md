...
---
> Codex compatibility: migrated from `.claude/skills/brainstorm/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, WebSearch, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$brainstorm`. If structured user input
