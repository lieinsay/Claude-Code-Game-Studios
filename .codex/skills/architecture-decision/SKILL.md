...
---
> Codex compatibility: migrated from `.claude/skills/architecture-decision/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$architecture-decision`. If structured user input
