...
---
> Codex compatibility: migrated from `.claude/skills/tech-debt/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$tech-debt`. If structured user input
