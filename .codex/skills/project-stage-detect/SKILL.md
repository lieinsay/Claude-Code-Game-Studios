...
---
> Codex compatibility: migrated from `.claude/skills/project-stage-detect/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Write", "model": "haiku"}`.
>
> Invocation in this template uses `$project-stage-detect`. If structured user input
