...
---
> Codex compatibility: migrated from `.claude/skills/smoke-check/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Write, AskUserQuestion"}`.
>
> Invocation in this template uses `$smoke-check`. If structured user input
