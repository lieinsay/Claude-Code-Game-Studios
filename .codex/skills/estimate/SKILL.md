...
---
> Codex compatibility: migrated from `.claude/skills/estimate/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$estimate`. If structured user input
