...
---
> Codex compatibility: migrated from `.claude/skills/playtest-report/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$playtest-report`. If structured user input
