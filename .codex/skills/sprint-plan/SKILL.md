...
---
> Codex compatibility: migrated from `.claude/skills/sprint-plan/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Task, AskUserQuestion", "context": "|"}`.
>
> Invocation in this template uses `$sprint-plan`. If structured user input
