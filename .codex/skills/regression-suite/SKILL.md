...
---
> Codex compatibility: migrated from `.claude/skills/regression-suite/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit"}`.
>
> Invocation in this template uses `$regression-suite`. If structured user input
