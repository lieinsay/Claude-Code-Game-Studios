...
---
> Codex compatibility: migrated from `.claude/skills/patch-notes/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash", "model": "haiku", "agent": "community-manager"}`.
>
> Invocation in this template uses `$patch-notes`. If structured user input
