...
---
> Codex compatibility: migrated from `.claude/skills/sprint-status/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep", "model": "haiku"}`.
>
> Invocation in this template uses `$sprint-status`. If structured user input
