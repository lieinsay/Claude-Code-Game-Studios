...
---
> Codex compatibility: migrated from `.claude/skills/test-helpers/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$test-helpers`. If structured user input
