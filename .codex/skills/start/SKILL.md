...
---
> Codex compatibility: migrated from `.claude/skills/start/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, AskUserQuestion"}`.
>
> Invocation in this template uses `$start`. If structured user input
