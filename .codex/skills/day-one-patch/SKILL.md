...
---
> Codex compatibility: migrated from `.claude/skills/day-one-patch/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, Bash, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$day-one-patch`. If structured user input
