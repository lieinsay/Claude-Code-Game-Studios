...
---
> Codex compatibility: migrated from `.claude/skills/team-combat/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-combat`. If structured user input
