...
---
> Codex compatibility: migrated from `.claude/skills/team-release/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-release`. If structured user input
