...
---
> Codex compatibility: migrated from `.claude/skills/review-all-gdds/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Bash, AskUserQuestion, Task", "model": "opus"}`.
>
> Invocation in this template uses `$review-all-gdds`. If structured user input
