...
---
> Codex compatibility: migrated from `.claude/skills/skill-test/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$skill-test`. If structured user input
