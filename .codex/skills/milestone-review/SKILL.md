...
---
> Codex compatibility: migrated from `.claude/skills/milestone-review/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Task, AskUserQuestion"}`.
>
> Invocation in this template uses `$milestone-review`. If structured user input
