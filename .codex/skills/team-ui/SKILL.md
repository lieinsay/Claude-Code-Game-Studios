...
---
> Codex compatibility: migrated from `.claude/skills/team-ui/SKILL.md`. Original Claude-specific metadata
...
>
> Invocation in this template uses `$team-ui`. If structured user input
