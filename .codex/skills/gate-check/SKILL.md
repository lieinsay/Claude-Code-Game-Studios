...
---
> Codex compatibility: migrated from `.claude/skills/gate-check/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Bash, Write, Task, AskUserQuestion", "model": "opus"}`.
>
> Invocation in this template uses `$gate-check`. If structured user input
