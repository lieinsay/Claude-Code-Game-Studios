...
---
> Codex compatibility: migrated from `.claude/skills/ux-design/SKILL.md`. Original Claude-specific metadata
...
> `{"user-invocable": "true", "allowed-tools": "Read, Glob, Grep, Write, Edit, AskUserQuestion, Task", "agent": "ux-designer"}`.
>
> Invocation in this template uses `$ux-design`. If structured user input
