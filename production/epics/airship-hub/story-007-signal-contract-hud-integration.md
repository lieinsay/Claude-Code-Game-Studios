...
**Required evidence**: `tests/integration/hub/HubSignalContractTest.csproj` — must exist and pass
**Status**: [x] Created and passing
**Review evidence**: 2026-05-12 Codex review reran `dotnet run --no-build --project tests/integration/hub/HubSignalContractTest.csproj` — PASS (4/4 checks)
