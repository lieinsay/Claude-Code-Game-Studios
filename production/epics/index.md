...
| Epic | System # | GDD | Governing ADRs | TRs | Stories | Status |
|------|----------|-----|----------------|-----|---------|--------|
| [scene-composition-system](scene-composition-system/EPIC.md) | #19 | scene-composition-system.md | ADR-0001, ADR-0012, ADR-0016, ADR-0017, ADR-0019, GDD #20 | 3 | 4 (001-004 Complete) | **Complete — release handoff BLOCKED_FOR_RELEASE for implementation evidence, #20 contract gaps, screenshots, P0 asset gaps, and tracked waivers** |
| [scene-physics-unit-system](scene-physics-unit-system/EPIC.md) | #20 | scene-physics-unit-system.md | ADR-0004, ADR-0019, GDD #19 | 3 | 4 (001-004 Complete) | **Complete** |
