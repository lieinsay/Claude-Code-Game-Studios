...
- Voyage design clarification: first-pass core fun is navigation judgment, with driving feel and atmosphere as support. Voyage problems include environmental hazards and adversarial encounters, but first pass has no active firing; players solve encounters by avoiding, shaking pursuit, disrupting, tanking risk, or retreating.
